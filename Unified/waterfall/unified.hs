...
ps1 :: Waterfall.Path
ps1 = Waterfall.fromPath2D (Path2D.pathFrom2D ps1c1e
...
ps2 :: Waterfall.Path
ps2 = Waterfall.fromPath2D (Path2D.pathFrom2D ps2c1e
...
ps3 :: Waterfall.Path
ps3 = Waterfall.fromPath2D (Path2D.pathFrom2D ps3c1e
...
ps4 :: Waterfall.Path
ps4 = Waterfall.fromPath2D (Path2D.pathFrom2D ps4c1e
...
ps5 :: Waterfall.Path
ps5 = Waterfall.fromPath2D (Path2D.pathFrom2D ps5c1e
...
lofters :: Solids.Solid
lofters = Transforms.mirror (V3 0 1 0) (Loft.loft
    [ (Transforms.translate (V3 0 0 ps1r) ps1)
    , (Transforms.translate (V3 0 0 ps2r) ps2)
    , (Transforms.translate (V3 0 0 ps3r) ps3)
    , (Transforms.translate (V3 0 0 ps4r) ps4)
    , (Transforms.translate (V3 0 0 ps5r) ps5)
    ])
