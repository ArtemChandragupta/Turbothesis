...
# ╔═╡ 9cb1b9a9-6cbe-4b6a-b3ec-953621a02cfc
begin
	function calc_turb_A(C, Å, 𝒞 = CONST, 𝒯 = TASK)
		T⃰₀ = Å.T⃰₀
		P⃰₀ = 𝒞.σ⃰ₖₛ * C.P⃰ₖ
		p₂ = 0.0795e6
		Πₜ = p₂ / P⃰₀
		...
		(; T⃰₀, P⃰₀, p₂, Πₜ, τₜ, τ, Π, nₚ, ηₚ, αₚ, Nₖ, Nₜ, Gᵧ, Hᵤₜ, ΔT⃰, T⃰₂, aᵏʳ₂, c₂ₜ, Hₐₜ, H₀ₜ, C₀, u, T⃰₂ₜₜ, T₂T, ρ₂ₜ, F₂ₜ, d₂ₘ, l₂, kₘ)
	end
	
	md"λ Расчет турбины Андрея"
end
...
begin
	function find_GΦΨ(T, Φ➞, Ψ➞, l̄)
		...
		for Φᵢ in Φ➞
			for Ψᵢ in Ψ➞
				(Gᵢ, Hᵢ) = find_Gₒₚₜ(T, Φᵢ, (Ψᵢ, Ψᵢ, Ψᵢ, Ψᵢ), l̄)
				if abs(Gᵢ - T.Gᵧ) < 0.01
...
# ╔═╡ 77acd60b-1edb-4d7b-a3ab-2010569e8eab
P

# ╔═╡ d6a511af-5154-4333-8f39-ae2b7555a94f
S[4].α₁

# ╔═╡ 22e5d325-82e6-4366-aebe-37f9d395d0b5
S

# ╔═╡ 7e4039e8-ed6c-46eb-a079-9df82d4272d6
@bind Cα₁ PlutoUI.NumberField(13:40, default=30)
