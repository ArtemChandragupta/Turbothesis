...
begin
	...
	const CONST = (
		...
		σ⃰ₖₛ  = 0.990, # Коэфф. потерь в камере сгорания
		kₙₜ  = 1.018,
		λ₂ₜ  = 0.4,
		ηₐₜ  = 0.91,
		å    = 90,
...
begin
	function build_geometry_new(T, 𝒯 = TASK)
...
# ╔═╡ ae440097-d4f9-46e1-94b8-f1a162bde562
T.P₂ₜ

# ╔═╡ 0cf0a49f-b8b7-47b3-8af3-523950137b3e
T.d₂ₘ

# ╔═╡ c704eca8-2ca6-4a1c-8814-00b8530b3050
T.l₂
...
# ╔═╡ 4ea2aef8-5971-442c-ac4e-4926a3d0f62c
begin
	function calc_comp_s(Å, 𝒞 = CONST, 𝒯 = TASK)
		P⃰₁   = 𝒞.σ⃰ᵢₙ * 𝒯.Pₙ
		P⃰ₖ   = 𝒯.Pₙ * Å.π⃰ₖ
		P⃰₂   = P⃰ₖ / 𝒞.σ⃰ₒᵤₜ
		H⃰ₖ   = 𝒞.kₙ/(𝒞.kₙ-1) * 𝒞.Rₙ * 𝒯.Tₙ * ( (P⃰₂/P⃰₁)^( (𝒞.kₙ-1)/𝒞.kₙ)-1 ) / 𝒞.η⃰ₐ
...
# ╔═╡ e7960f98-a6df-47f2-bc41-8e6af12505d0
begin
	function calc_turb_s(C, Å, 𝒞 = CONST, 𝒯 = TASK)
		P⃰₀   = 𝒞.σ⃰ₖₛ * C.P⃰ₖ
		Nₜ   = 𝒯.N + C.H⃰ₖ * Å.Gₙ
		Hᵤₜ  = 𝒞.kₙₜ * Nₜ / Å.Gᵧ
		ΔT⃰ₜ  = Hᵤₜ / 𝒞.Cpᵧ
		...
		(; P⃰₀, Nₜ, Hᵤₜ, ΔT⃰ₜ, T⃰₂ₜ, aᵏʳ₂, c₂ₜ, Hₐₜ, Hₒₜ, T⃰₂ₜₜ, P₂ₜ)
	end
