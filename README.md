...
Все переменные и рассчеты (кроме тех, которые из графиков) в документе автоматизированны с помощью Jupyter, при изменении любых данных вводить всё заново не придётся.
