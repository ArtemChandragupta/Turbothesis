...
ax1.plot(x1,f1,'-', label = r'$T_1 = 1543 \ K$', markersize=2)
ax1.plot(x2,f2,'-', label = r'$T_1 = 1593 \ K$', markersize=2)
ax1.plot(x3,f3,'-', label = r'$T_1 = 1643 \ K$', markersize=2)
ax1.plot(x4,f4,'-', label = r'$T_1 = 1693 \ K$', markersize=2)
ax1.plot(x5,f5,'-', label = r'$T_1 = 1743 \ K$', markersize=2)

ax2.plot(x1,h1,'-', label = r'$T_1 = 1543 \ K$', markersize=2)
ax2.plot(x2,h2,'-', label = r'$T_1 = 1593 \ K$', markersize=2)
ax2.plot(x3,h3,'-', label = r'$T_1 = 1643 \ K$', markersize=2)
ax2.plot(x4,h4,'-', label = r'$T_1 = 1693 \ K$', markersize=2)
ax2.plot(x5,h5,'-', label = r'$T_1 = 1743 \ K$', markersize=2)

ax3.plot(x1,k1,'-', label = r'$T_1 = 1543 \ K$', markersize=2)
ax3.plot(x2,k2,'-', label = r'$T_1 = 1593 \ K$', markersize=2)
ax3.plot(x3,k3,'-', label = r'$T_1 = 1643 \ K$', markersize=2)
ax3.plot(x4,k4,'-', label = r'$T_1 = 1693 \ K$', markersize=2)
ax3.plot(x5,k5,'-', label = r'$T_1 = 1743 \ K$', markersize=2)
...
fig.tight_layout()
plt.savefig('A2GTP.pdf', bbox_inches='tight', backend='pgf')
