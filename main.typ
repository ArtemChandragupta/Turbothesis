...
Исследования были проведены на модели "бандажированная турбинная ступень --- осевой диффузор" газовой турбины мощностью 1000 МВт, выполненной в масштабе 1:8.53 и установленной на экспериментальном стенде ЭТ-4 в лаборатории Турбиностроения. Радиальный зазор регулируется с помощью сменного дистанционного кольца. Эскиз стенда показан на @spec-model.
