...
Проектируемая установка предназначена для преобразования тепловой энергии, получаемой в результатае сжигания топлива в энергию вращения вала, которая используется для привода электрогенератора номинальной мощностью 65 МВт. Применение установки возможно как в составе ПГУ, так и в качестве независимого агрегата. ГТУ может служить 
...
+ зубья передачи имеют модуль 10, упрочнены азотированием.
