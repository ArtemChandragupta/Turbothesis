...
На @rho-groth показано распределение кинематической и термодинамической степени реактивности по сечениям за последней ступенью турбины, обеспеченное обратным законом закрутки в результате расчета. Видно, что рост обоих степеней реактивности близок к линейному.
...
Критерием опатимального значения является наименьшее отклонение роста далений $p_2$ от линейного, выраженное в минимизации параметра $sigma$. Оптимальное значение показано на @var красной точкой.
