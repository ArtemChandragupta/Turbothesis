...
где $Q_{\text{p}}^{\text{н}}=\Qnp \ \tfrac{\text{кДж}}{\text{К}}$ - низшая теплота сгорания топлива;

$h_{\text{т}}=\htop$ - Энтальпия топлива (пренебрежимо мала);

$(c_{p_{\text{г}}})_{\alpha=1}=\Cpao\ \tfrac{\text{кДж}}{\text{К}}$ - Удельная теплоемкость газа при $\alpha=1$;

$L_{0}=15 \ \tfrac{\text{кг}_{\text{возд}}}{\text{кг}_{\text{топ}}}$ - Стехиометрический коэффициент.
