...
\newpage
\section{\raggedright Термодинамический и газодинамический расчет}
...
\begin{enumerate} 
  ...
  \item Прототип установки – ГТЭ-65, изображён на рисунке \ref{Prototype.png};
...
\image{Prototype.png}{Схематическое изображение прототипа – ГТЭ-65.}{0.8}
...
\newpage
\subsection{\raggedright Методы и пример расчета параметров рабочего процесса в характерных сечениях проточной части ГТУ. Определение основных характеристик ГТУ}
