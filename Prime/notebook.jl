...
begin
	...
	const CONST = (
		...
		σ⃰ₖₛ  = 0.96,  # Коэффициент потерь в камере сгорания
		σ⃰₄   = 0.985, # Коэффициент потерь в выходном устройстве
...
function calc_prime(𝒞 = CONST, 𝒯 = TASK)
	...
	T⃰₁  = 𝒯.Tₙ
	P⃰₂  = 𝒯.π⃰ₖ * P⃰₁
	T⃰₂  = 𝒯.Tₙ * 𝒯.π⃰ₖ^((kₙ-1)/kₙ)
	H⃰ₒₖ = 𝒞.Cpₙ * T⃰₁ * ( 𝒯.π⃰ₖ^((kₙ-1)/kₙ) - 1 )
	Hₖ  = H⃰ₒₖ / 𝒞.ηₐ
	P⃰₃  = P⃰₂ * 𝒞.σ⃰ₖₛ
	P⃰₄  = 𝒯.Pₙ / 𝒞.σ⃰₄
	π⃰ₜ  = P⃰₃ / P⃰₄
...
function calc_comp(I, C, π⃰ₖ, 𝒞 = CONST, 𝒯 = TASK)
	...
	l₂   = 1/2 * (1/ν₂ - 1) * Dᵥₜ₁
	uₙ₁  = 𝒯.n * π * D₁ / 60
	H⃰ₐ   = (I.kₙ / (I.kₙ-1)) * 𝒞.Rₙ * T⃰₁ * ( (P⃰₂/P⃰₁)^((I.kₙ-1)/I.kₙ) - 1 )
	H⃰ₖ   = H⃰ₐ / η⃰ₐ
	i    = ceil(H⃰ₖ / hₘ)
	h₁   = 0.65hₘ
	h₂   = 1.15hₘ
	...
	(;σ⃰ᵢₙ, σ⃰ₒᵤₜ, η⃰ₐ, nₖ, cᶻ₁, cᶻ₂, ν₁, Ω, hₘ, P⃰₁, T⃰₁, P⃰ₖ, P⃰₂, ρ₁, ρ₂, D₁, Dᵥₜ₁, Dₘ₁, l₁, F₂, ν₂, l₂, uₙ₁, H⃰ₐ, H⃰ₖ, i, h₁, h₂, uₘ₁, Φ₁, h̄₁, otn, otm, P₀ᵍ, J, tb, tbem, u, cᵤ₁, cᵤ₂, c₁, α₁, T₁, wᵤ₁, w₁, Mʷ₁, β₁, Δcᶻ, Ocᶻ₂, c₂, α₂, wᵤ₂, w₂, β₂, ϵ, Φₙ, Mʷₘ)
end
