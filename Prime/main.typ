...
Эффективный КПД ГТУ:
$ eta_e = (H_т dot eta_"мт" - H_к / eta_"мк") / Q_1 $

Коэффициент полезной работы ГТУ:
$ phi = (H_т dot eta_"мт" - H_к / eta_"мк") / (H_т dot eta_"мт") = $
