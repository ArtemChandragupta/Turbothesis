...
$ Q'_1 &= c_p_г dot (T_3^* - T_2^*) = \ &= COCpₙ dot (TATs3 - ITs2) =  IQ̇1 "Дж/кг"; $
...
При приближенном расчете осевого компрессора основными расчетными сечениями являются: сечение 1-1 на входе в первую ступень и сечение 2-2  на выходе из последней ступени ( @COMP-full[рис.] ). Определим параметры $P$ и $T$ в трех сечениях:
