...
$ rho_2 = rho_1 (P_2^* / P_1^*)^(1/n) = Cρ1 (CPs2 / CPs1)^(1/COnₖ)  = Cρ2; $

$ k / (k-1) dot eta_"ад"^* = n/(n-1) $

$ COkᵧ / (COkᵧ - 1) dot COηₐ = n/(n-1) => n = COnₖ; $
...
$ H_"ут" = k_N dot N_т/G_г = COkₙ dot TNₜ / TGᵧ = THᵤₜ; $
...
$ alpha_"кр"_2 = sqrt( (2 dot k_г)/(k_г+1) R_г T^*_(2 т) ) = sqrt( (2 COkᵧ)/(COkᵧ+1) dot CORᵧ dot TTs2ₜ ) = Taᵏʳ2; $
