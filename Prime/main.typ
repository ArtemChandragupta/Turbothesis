...
Примем величины осевой составляющей абсолютных скоростей в сечениях 1-1 и 2-2 соответственно $C_(z_1) = $ и $C_(z_2) = $. Втулочное отношение выберем $nu_{1} = $. Расход воздуха $G_"в" $.
